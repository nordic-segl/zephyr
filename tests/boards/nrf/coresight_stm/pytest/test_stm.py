...
def _check_benchmark_results(output: str, core: str, constraints: STMLimits) -> None:
    ...
    ), f"{core}: Timing for log message with 0 arguments {latency_msg_0} us exceeds {threshold} us"
    ...
    ), f"{core}: Timing for log message with 1 argument {latency_msg_1} us exceeds {threshold} us"
    ...
    ), f"{core}: Timing for log message with 2 arguments {latency_msg_2} us exceeds {threshold} us"
    ...
    ), f"{core}: Timing for log message with 3 arguments {latency_msg_3} us exceeds {threshold} us"
    ...
    ), f"{core}: Timing for log message with string {latency_msg_string} us exceeds {threshold} us"
    ...
    ), f"{core}: Timing for tracepoint {latency_tracepoint} us exceeds {threshold} us"
    ...
    ), f"{core}: Timing for tracepoint_d32 {latency_tracepoint_d32} us exceeds {threshold} us"
